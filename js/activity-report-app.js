  ...
  function convertSectionTitlesToOutlookShadeTables(root) {
    root.querySelectorAll(".section-title").forEach((el) => {
      ...
      const titleStyle = isManpowerMajor
        ? `background-color:${bg};border-left:8px solid ${borderLeft};padding:9px 12px;mso-line-height-rule:exactly;`
        : `background-color:${bg};border-left:8px solid ${borderLeft};padding:7px 10px;mso-line-height-rule:exactly;`;
